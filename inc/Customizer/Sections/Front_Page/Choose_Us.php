<?php
/**
 * Choose_Us class file for customizer
 *
 * @package cleaner
 */
...
class Choose_Us extends Front_Page {
    protected $section     = 'front_page_choose_us_section';
    protected $option_name = 'front_page_choose_us_section';
    ...
    public function register_section() {
        \Kirki::add_section( $this->section, [
            'title'    => esc_html__( 'Choose Us Section', 'cleaner' ),
            'panel'    => $this->panel,
            'priority' => 160,
        ] );
    }
    ...
    public function register_fields() {
        \Kirki::add_field( $this->config, [
            'type'      => 'background',
            'settings'  => 'front_page_choose_us_section_background',
        ...
        \Kirki::add_field( $this->config, [
            ...
            'partial_refresh' => [
                $this->section . 'section_title' => [
                    'selector'        => '#choose-us .section-title',
        ...
        \Kirki::add_field( $this->config, [
            ...
            'partial_refresh' => [
                $this->section . 'section_description' => [
                    'selector'        => '#choose-us .section-description',
                    'render_callback' => function () {
        ...
        \Kirki::add_field( $this->config, [
            'type'         => 'repeater',
            'label'        => esc_html__( 'Choose us items', 'cleaner' ),
            'section'      => $this->section,
            'priority'     => 10,
            'row_label'    => [
                'type'  => 'field',
            ...
            'partial_refresh' => [
                $this->section . 'choose_us_items' => [
                    'selector'        => '#choose-us .choose_us-items',
                    'render_callback' => function () {
                        return get_option( $this->option_name )['choose_us_items'];
                    },
                ],
            ],
        ] );
